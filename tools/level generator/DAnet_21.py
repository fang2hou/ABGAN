import torch
import sys
import abganlibs.models.DAnet as dcgan
import numpy as np

# Check the parameter is legal or not
if 1 == len(sys.argv) or ".pth" != sys.argv[1][-4:]:
    saved_model = "saves/DAnet_21/netG_epoch_1000_32.pth"
...
for i, result in enumerate(results, 1):
    ...
    np.savetxt('data/generated_data_DAnet_21/from_net_{0:02d}.gz'.format(i),
